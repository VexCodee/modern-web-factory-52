...
const testimonials: TestimonialProps[] = [
  {
    quote: "TechPrime's web development services helped us increase our online sales by 40%. Their team was professional, responsive, and delivered beyond our expectations.",
    name: "Sarah Johnson",
    position: "CEO",
  ...
  {
    quote: "The AI solution implemented by TechPrime revolutionized our customer service operations. We've seen incredible improvements in response times and customer satisfaction.",
    name: "Michael Chen",
    position: "CTO",
  ...
  {
    quote: "Their social media management strategies completely transformed our brand presence. We've seen a 200% increase in engagement and a significant boost in leads.",
