...
const ServiceCard: React.FC<ServiceCardProps> = ({
  ...
  return <div className="service-card bg-white p-6 rounded-xl shadow-sm border border-gray-100 opacity-0 translate-y-4" style={{
    transitionDelay: `${delay}ms`
      ...
      <div className="mt-5 opacity-0 group-hover:opacity-100 transition-opacity h-0 group-hover:h-auto overflow-hidden">
        <Link to="/services" className="text-primary font-medium hover:underline inline-flex items-center text-sm">
          Learn more
...
const ServiceSection = () => {
  ...
  return <section id="services" className="py-24 bg-gray-50 service-section" ref={sectionRef}>
      {/* Decorative elements */}
      ...
      <div className="container mx-auto px-6">
        <div className="text-center max-w-3xl mx-auto mb-16">
          ...
          <h2 className="mt-6 text-3xl md:text-4xl font-display font-bold animate-fade-in" style={{
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          {services.map((service, index) => <div key={index} className="group hover-lift">
              <ServiceCard icon={service.icon} title={service.title} description={service.description} delay={service.delay} />
            </div>)}
        </div>
        ...
        animationDelay: '900ms'
          ...
          <Link to="/services" className="inline-flex items-center text-primary font-medium hover:underline transition-all hover:translate-x-1">
            {t('services.viewAll')}
