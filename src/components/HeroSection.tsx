...
const HeroSection = () => {
  ...
  return (
    <section 
      ref={heroRef}
      className="relative overflow-hidden bg-gradient-to-b from-gray-50 to-white pt-16 md:pt-24 pb-16"
    >
        ...
        <div className="flex flex-col lg:flex-row items-center">
          <div className="w-full lg:w-1/2 mb-12 lg:mb-0 lg:pr-10 z-10">
            ...
            <div className="flex flex-col sm:flex-row space-y-4 sm:space-y-0 sm:space-x-4 animate-fade-in" style={{ animationDelay: '600ms' }}>
              <Link 
                to="/contact" 
                className="bg-primary text-white px-8 py-3 rounded-full font-medium flex items-center justify-center transition-all hover:bg-primary/90 hover:shadow-lg hover:-translate-y-1"
              >
                {t('hero.getStarted')}
              ...
              <Link 
                to="/services" 
                className="bg-white text-gray-800 border border-gray-200 px-8 py-3 rounded-full font-medium flex items-center justify-center transition-all hover:bg-gray-50 hover:shadow hover:-translate-y-1"
              >
                {t('hero.ourServices')}
              </Link>
            </div>
            ...
            <div 
              className="hidden md:flex items-center mt-16 space-x-2 text-gray-500 cursor-pointer animate-fade-in animate-on-scroll opacity-0" 
          ...
          <div className="w-full lg:w-1/2 relative flex justify-center z-10">
            <div className="relative w-full max-w-lg">
              ...
              <div className="absolute top-20 -right-4 w-72 h-72 bg-accent opacity-20 rounded-full mix-blend-multiply filter blur-xl animate-pulse-subtle hero-decorative-element" style={{ animationDelay: '2s' }}></div>
              ...
              <div className="relative glass-card rounded-2xl p-5 animate-scale-in hero-image-card" style={{ animationDelay: '200ms' }}>
                ...
                />
                <div className="absolute -bottom-6 -right-6 bg-white rounded-lg p-4 shadow-lg animate-slide-in-bottom hero-stat-card" style={{ animationDelay: '600ms' }}>
                ...
                <div className="absolute -top-6 -left-6 bg-white rounded-lg p-4 shadow-lg animate-slide-in-bottom hero-stat-card" style={{ animationDelay: '800ms' }}>
                  <div className="flex items-center space-x-3">
                ...
                <div className="absolute -top-12 right-10 bg-white rounded-lg p-3 shadow-lg animate-fade-in animate-on-scroll opacity-0" style={{ animationDelay: '1000ms' }}>
