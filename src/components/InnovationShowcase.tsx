...
const InnovationCard = ({
  ...
  return (
    <div className={`absolute ${position} z-10 shadow-md rounded-xl p-3 innovation-card ${className}`}>
...
const AvatarGroup = () => {
  return (
    <div className="absolute top-8 right-8 z-10 bg-white dark:bg-gray-800 rounded-full px-3 py-1.5 shadow-md flex items-center gap-2">
          ...
          <div className="relative order-2 lg:order-1">
            ...
            <div className="relative bg-white dark:bg-gray-800 p-6 rounded-3xl shadow-xl overflow-hidden animate-on-scroll opacity-0">
              <img 
                ...
                src="/lovable-uploads/cee4abde-6d12-45dd-b5e7-34d1ec2af13f.jpg" 
              />
