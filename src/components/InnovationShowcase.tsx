...
const InnovationCard = ({
  ...
  return <div className={`absolute ${position} z-10 shadow-md rounded-xl p-3 innovation-card ${className}`}>
...
const AvatarGroup = () => {
  return <div className="absolute top-8 right-8 z-10 bg-white dark:bg-gray-800 rounded-full px-3 py-1.5 shadow-md flex items-center gap-2">
...
const InnovationShowcase = () => {
  ...
  const benefits = [t('innovation.benefits.automated'), t('innovation.benefits.ai'), t('innovation.benefits.cloud'), t('innovation.benefits.security')];
  useEffect(() => {
  ...
  return <section ref={showcaseRef} className="relative py-24 overflow-hidden">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="relative order-2 lg:order-1">
            ...
            <div className="relative bg-white dark:bg-gray-800 p-6 rounded-3xl shadow-xl overflow-hidden animate-on-scroll opacity-0">
              <img alt="Innovation showcase" className="w-full h-auto rounded-xl z-0" src="/lovable-uploads/6c328da1-eea9-44a8-981f-781f79a3a46a.jpg" />
              
              {/* Floating innovation card - top left */}
              <InnovationCard title="Wydajność" description="Zoptymalizowane procesy" position="top-8 left-8" icon={<Zap className="h-5 w-5 text-blue-600 dark:text-blue-400" />} />
              
              {/* Additional card with avatars - top right */}
              <AvatarGroup />
              
              {/* Additional innovation card - bottom right */}
              <InnovationCard title="Innowacja" description="Rozwiązania przyszłości" position="bottom-8 right-8" icon={<Check className="h-5 w-5 text-blue-600 dark:text-blue-400" />} className="bg-white/90 backdrop-blur-sm dark:bg-gray-800/90" />
            </div>
          ...
          <div className="lg:col-span-1 order-1 lg:order-2">
            <div className="space-y-6">
              ...
              <ul className="space-y-5 mb-10">
                {benefits.map((item, index) => <li key={index} className="flex items-center animate-on-scroll opacity-0 dark:text-white" style={{
