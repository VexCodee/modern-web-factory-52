        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="relative order-2 lg:order-1">
            ...
            <div className="relative bg-white dark:bg-gray-800 p-6 rounded-3xl shadow-xl overflow-hidden animate-on-scroll opacity-0">
              <img src="public/lovable-uploads/feccc29d-e2b8-4091-afee-3e7ec19caaf4.png" alt="Innovation showcase" className="w-full h-auto rounded-xl z-0" />
              
              {/* Floating innovation card - top */}
              <InnovationCard title="Innowacja" description="Rozwiązania przyszłości" position="top-8 left-8" icon={<Zap className="h-5 w-5 text-purple-600 dark:text-purple-400" />} />
              
              {/* Floating efficiency card - bottom */}
              <InnovationCard title="Wydajność" description="Zoptymalizowane procesy" position="bottom-8 left-8" icon={<Zap className="h-5 w-5 text-blue-600 dark:text-blue-400" />} />
              
              {/* Additional card with avatars - optional */}
              
              
              {/* Additional innovation card - bottom right */}
              <InnovationCard title="Innowacja" description="Rozwiązania przyszłości" position="bottom-8 right-8" icon={<Check className="h-5 w-5 text-blue-600 dark:text-blue-400" />} className="bg-white/90 backdrop-blur-sm" />
            </div>
